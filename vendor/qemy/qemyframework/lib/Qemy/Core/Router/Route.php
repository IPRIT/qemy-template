...
class Route extends AbstractRoute {
    ...
    public function getControllerName() {
        ...
        if (isset($broken_uri[1]) && !empty($broken_uri[1])) {
            $controller_name = $this->findController($broken_uri[1], $this->companyPromise);
            if (!$controller_name) {
                $controller_name = Route::NOT_FOUND_CONTROLLER;
            }
        } else {
    ...
    public function setCompanyControllerPromise($flag = true) {
        $this->companyPromise = $flag;
    }
